...
Manual computation of performance metrics
ROC & AUC analysis
Comparison across all algorithms

The goal is to understand which algorithm performs best and how model selection impacts classification performance in medical diagnosis tasks.
